                ...
                <div className="flex flex-col h-full">
                    <nav className="px-8 py-6 flex-1">
                        <ul className="space-y-4">
                            <li>
                                <button className="flex items-center justify-between w-full text-white font-onest font-bold text-base uppercase" onClick={()=>{onClose(); stateCatalogDrawer.open()}}>
                                    <span>Каталог</span>
                                    <svg data-v-b78234a2="" width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-v-b78234a2="" d="M1 1L7 7L1 13" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                                </button>
                            </li>
                            <li>
                                <Link className="flex items-center justify-between text-white font-onest font-bold text-base uppercase" href="/catalog/new" onClick={onClose}>
                                    <span>Новинки</span>
                                    <svg data-v-b78234a2="" width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-v-b78234a2="" d="M1 1L7 7L1 13" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                                </Link>
                            </li>
                            <li>
                                <Link className="flex items-center justify-between text-white font-onest font-bold text-base uppercase" href="/contacts" onClick={onClose}>
                                    <span>Контакты</span>
                                    <svg data-v-b78234a2="" width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-v-b78234a2="" d="M1 1L7 7L1 13" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                                </Link>
                            </li>
                    ...
                    <div className="px-8 py-4 flex items-center gap-4">
                        <Link className="text-white hover:opacity-80" href="https://t.me/rentalbees">
                            <svg data-v-b78234a2="" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path data-v-b78234a2="" d="M18.5 2L9 11.5M18.5 2L12.5 18L9 11.5M18.5 2L1.5 8L9 11.5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                        </Link>
                        ...
                        <Link className="text-white hover:opacity-80" href="https://instagram.com/rentalbees">
                            <svg data-v-b78234a2="" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><rect data-v-b78234a2="" x="1" y="1" width="18" height="18" rx="5" stroke="white" stroke-width="2"></rect><circle data-v-b78234a2="" cx="10" cy="10" r="4" stroke="white" stroke-width="2"></circle><circle data-v-b78234a2="" cx="15.5" cy="4.5" r="1.5" fill="white"></circle></svg>
                        </Link>
                    </div>
                    <div className="px-8 py-4 bg-[#f0f5e6] w-full">
                        <p className="text-[#5B5C5E] text-sm font-onest font-medium mb-1">служба поддержки</p>
                        <Link className="text-[#5B5C5E] text-base font-onest font-medium hover:text-[#aeca73] transition-colors" href="tel:+79852719381"> +7 985 271-93-81 </Link>
                    </div>
                </div>
              </DrawerBody>
