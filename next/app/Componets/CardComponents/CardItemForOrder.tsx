...
/*
Отображение товара в корзине со статусом "Арендован", т.е. товар для прошлого заказа.
*/
type props={
    item:cardItemsType,
}
export default function CardItemForOrder({item}:props){
    type Unit = 'mm' | 'sm' | 'm'
    ...
    return(
        <Link className="flex space-x-1 border border-[#aeca73] border-xl rounded-2xl w-full transform transition hover:scale-102 relative text-sm lg:text-md"
